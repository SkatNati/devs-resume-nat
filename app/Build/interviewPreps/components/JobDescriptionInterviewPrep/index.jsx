...
import { useJobDesc } from "../../hook/useJobDesc";

const JobDescriptionInterviewPrep = () => {
  const { jobDescriptionFields, form, onSubmit, isLoading, isAiGenerating } =
    useJobDesc();
  if (isAiGenerating) {
...
export default JobDescriptionInterviewPrep;
