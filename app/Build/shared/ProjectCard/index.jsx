...
const ProjectCard = ({ text, desc, handleCreateCV, isLoading }) => {
  return (
    <div className="p-6 bg-white rounded-lg relative w-[300px] py-4 flex flex-col  shadow-md ">
      <svg
      ...
      <div className="absoluste bottom-3" onClick={handleCreateCV}>
        <ButtonComp
          disabled={isLoading}
